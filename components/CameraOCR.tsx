...
import { generateSocioeconomicaPDF, generateQuantitativoPDF, generateDeclaracaoRelatorioUnicoPDF } from './utils/pdfGenerators';
                          ...
                          <td className="py-3 px-4 text-center">
                            ...
                            {!isInactive && (
                              <div className="flex items-center justify-center gap-1.5 mt-1 flex-wrap">
                                ...
                                {/* Botão Relatório Único (Declaração PNE/Supervisão) */}
                                <button
                                  onClick={() => {
                                    const html = generateDeclaracaoRelatorioUnicoPDF(student, headerImage, true);
                                    setDocPreviewModal({ title: 'Declaração', htmlContent: html, studentName: student.nome });
                                  }}
                                  className="p-2 rounded-full border border-pink-200 bg-pink-50 text-pink-500 hover:bg-pink-100 transition-colors flex items-center justify-center"
                                  title="Gerar Declaração (Relatório Único)"
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
