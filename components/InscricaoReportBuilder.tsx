      ...
      <div ref={reportRef} className={`freq-report-content ${drawMode ? 'draw-active' : ''}`} onMouseDown={onDrawMouseDown}>
        ...
        {sorted.map((s, i) => {
          ...
          <div className="freq-page" style={{ padding: '40px 40px' }}>
            ...
            {hasInscricao ? (
              <div style={{ border: '1px solid #000', background: '#fff', padding: '15px 30px', fontSize: 9, lineHeight: 1.5, fontFamily: 'serif' }}>
                {/* Banner do projeto */}
                <div style={{ textAlign: 'center', marginBottom: 10 }}>
                  <img src={headerImage} alt="Header" style={{ width: '100%', maxHeight: 50, objectFit: 'contain' }} onError={e => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                </div>

                {/* Títulos centralizados */}
                <div style={{ textAlign: 'center', marginBottom: 12 }}>
                  <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1 }}>FICHA DE INSCRIÇÃO</p>
                  <p style={{ fontSize: 11, fontWeight: 700, marginTop: 2 }}>PROJETO {pName}</p>
                </div>
                ...
                <div style={{ marginBottom: 4, display: 'flex', gap: 20 }}>
                ...
                <div style={{ marginBottom: 4, display: 'flex', gap: 30 }}>
                ...
                {/* Termos legais */}
                <div style={{ fontSize: 9, lineHeight: 1.4, textAlign: 'justify' as const, color: '#000', marginBottom: 10 }}>
                  ...
                  <p style={{ marginBottom: 4 }}>Eu, responsável legal pelo(a) aluno(a) inscrito(a) no projeto, com fundamento no art. 5º, incisos X e XXVIII, da Constituição Federal de 1988; nos arts. 11, 18 e 20 da Lei nº 10.406/2002 (Código Civil); nos arts. 15 e 17 da Lei nº 8.069/1990 (Estatuto da Criança e do Adolescente – ECA); e no art. 14 da Lei nº 13.709/2018 (Lei Geral de Proteção de Dados Pessoais – LGPD), AUTORIZA o uso da imagem, nome e/ou voz do(a) aluno(a) inscrito(a) no projeto, para fins institucionais, educativos, esportivos, culturais, informativos, de prestação de contas, divulgação e promoção das atividades do projeto.</p>
                  <p style={{ marginBottom: 4 }}>A presente autorização compreende a reprodução e divulgação em sites, redes sociais, internet, mídia eletrônica, jornais, revistas, folders, relatórios, apresentações, materiais gráficos e audiovisuais, bem como em quaisquer meios de comunicação públicos ou privados, inclusive por parceiros, apoiadores e patrocinadores vinculados ao projeto.</p>
                  <p style={{ marginBottom: 4 }}>O uso da imagem, nome e/ou voz deverá respeitar a dignidade, honra, privacidade, integridade física e emocional e o melhor interesse da criança e do adolescente, sendo vedada qualquer utilização em situação vexatória, discriminatória, ofensiva ou diversa das finalidades institucionais do projeto.</p>
                  <p style={{ marginBottom: 4 }}>O(a) responsável legal declara estar ciente de que a presente autorização é concedida a título gratuito, sem geração de qualquer direito a indenização, remuneração ou compensação financeira decorrente do uso autorizado.</p>
                  <p style={{ marginBottom: 4 }}>Os dados pessoais e materiais coletados serão tratados em conformidade com a legislação vigente de proteção de dados pessoais, podendo o(a) responsável legal solicitar formalmente, a qualquer momento, a interrupção do uso futuro da imagem, nome e/ou voz do(a) participante, respeitados os materiais já produzidos e divulgados anteriormente no âmbito institucional do projeto.</p>
                  <p>Por ser verdade, firmo a presente autorização.</p>
                </div>
                ...
                <div style={{ textAlign: 'center', marginTop: 10 }}>
                  {s.assinatura ? (
                    <div>
                      <img src={s.assinatura} alt="Assinatura" style={{ height: 40, maxWidth: 200, objectFit: 'contain', display: 'block', margin: '0 auto 4px' }} />
                      <div style={{ width: 250, height: 1, background: '#000', margin: '0 auto' }}></div>
                    </div>
                  ) : (
                    <div style={{ width: 250, height: 1, background: '#000', margin: '20px auto 0' }}></div>
                  )}
                  <p style={{ fontSize: 9, marginTop: 4 }}>Assinatura do (a) responsável legal</p>
                </div>
              </div>
            ) : (
