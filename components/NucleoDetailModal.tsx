...
const getModalTheme = (projectId: ProjectId) => {
    ...
    if (projectId === 'INCENTIV_APP') return { gradient: 'from-indigo-600 to-blue-600', shadow: 'shadow-indigo-200', tabActive: 'text-indigo-600', tabBar: 'from-indigo-600 to-blue-600', addBtn: 'text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 border-indigo-200', dayOn: 'bg-indigo-600 text-white border-indigo-600', durBg: 'bg-indigo-50 border-indigo-100', durIcon: 'text-indigo-500', durText: 'text-indigo-700', avatar: 'bg-indigo-50 text-indigo-600', badge: 'bg-indigo-100 text-indigo-700 border-indigo-200', editBtn: 'text-indigo-500 hover:text-indigo-700', link: 'text-indigo-600 hover:text-indigo-800 bg-indigo-50', inputAlt: 'border-indigo-200 bg-indigo-50', actionHover: 'hover:border-indigo-300', ring: 'focus:ring-indigo-300' };
